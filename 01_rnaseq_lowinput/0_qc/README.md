...
This directory contains the scripts used to perform adapter trimming,
quality assessment, and threshold filtering.

#### Step 1. `run_qc.slurm` (Slurm Array Job)

- **Action:**
  - 1)  Runs `trim_galore` to remove adapter sequences and filters out
