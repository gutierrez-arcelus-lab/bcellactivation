...
In order to select individuals with European ancestry given PC coordinates, I computed the mean and SD for PC1 –PC4 in 1000 Genomes Europeans, and computed a z-score for each MGB individuals, selecting all individuals falling between -3 and +3 SDs at each PC.
