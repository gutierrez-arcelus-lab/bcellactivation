...
```{r het_score}
include_graphics("./mgb_biobank/plots/het_scores_points.png")
```

This are the distributions according the European ancestry:

```{r het_score_dens}
include_graphics("./mgb_biobank/plots/het_score_density.png")
```
...
```{r pca_het_score}
include_graphics("./mgb_biobank/plots/pca_het_scores.png")
```
