...
K=7 seems to make sense to extract the individuals with high European ancestry. I computed a heterogeneity score, defined as the degree of homogeneity regarding called continental groups at each cluster, using known continental groups for the 1000 Genomes data. For example, if at cluster X we have 90% of individuals from a 1000G European population, the score will equal 0.9.
