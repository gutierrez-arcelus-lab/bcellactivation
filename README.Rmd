...
```{r}
include_graphics("./bcell_bulk/plots/sle_genes_refalt.png")
```
...
There are ~30,000 variants which were actually genotyped on chrX, and rest was imputed. If we select the genotyped variants, we see higher heterozygosity.

```{r sex_genotyped}
include_graphics("./plots/chrX_het_genotyped.png")
```
